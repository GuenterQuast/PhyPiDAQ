...
class Ui_PhyPiWindow(object):
    def setupUi(self, PhyPiWindow):
        ...
        self.tab_Main.setGeometry(QtCore.QRect(-11, 0, 711, 591))
        ...
        self.pB_DeviceSelect0.setGeometry(QtCore.QRect(487, 426, 181, 34))
        ...
        self.pB_DeviceSelect1.setGeometry(QtCore.QRect(485, 424, 181, 34))
    ...
    def retranslateUi(self, PhyPiWindow):
        ...
        self.tabConfig.setTabText(self.tabConfig.indexOf(self.tab_DeviceConfig1), _translate("PhyPiWindow", "2nd DeviceConfig"))
...
# set iterable over Device Configs Tabs
      self.tab_DeviceConfigs = [self.tab_DeviceConfig0, self.tab_DeviceConfig1]
      self.pB_DeviceSelects = [self.pB_DeviceSelect0, self.pB_DeviceSelect1]  
      self.pTE_DeviceConfigs = [self.pTE_DeviceConfig0, self.pTE_DeviceConfig1]

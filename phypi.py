...
class Ui_PhyPiWindow(object):
    ...
    def retranslateUi(self, PhyPiWindow):
        ...
        self.pTE_phypiConfig.setToolTip(_translate("PhyPiWindow", "<html><head/><body><p>Comnfiguration File for Oscilloscope</p></body></html>"))
        ...
        self.pB_DeviceSelect.setToolTip(_translate("PhyPiWindow", "<html><head/><body><p>load template device configuration</p></body></html>"))
        self.pB_DeviceSelect.setText(_translate("PhyPiWindow", "   load Device Config"))
        self.tabConfig.setTabText(self.tabConfig.indexOf(self.tab_DeviceConfig), _translate("PhyPiWindow", "Device Config"))

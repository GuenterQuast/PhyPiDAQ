...
class Ui_PhyPiWindow(object):
    def setupUi(self, PhyPiWindow):
        ...
        self.label_caption.setGeometry(QtCore.QRect(160, 150, 431, 30))
        font = QtGui.QFont()
        ...
        self.lE_WorkDir.setGeometry(QtCore.QRect(160, 340, 371, 32))
        ...
        self.label_WorkDir.setGeometry(QtCore.QRect(76, 343, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Latin Modern Sans")
        font.setPointSize(11)
        ...
        self.pB_WDselect.setGeometry(QtCore.QRect(540, 340, 31, 34))

...
class Ui_PhyPiWindow(object):
    def setupUi(self, PhyPiWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(120, 50, 471, 81))
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")
        self.label_diagram = QtWidgets.QLabel(self.Tab_Control)
        self.label_diagram.setEnabled(True)
        self.label_diagram.setGeometry(QtCore.QRect(70, 0, 551, 201))
        self.label_diagram.setText("")
        self.label_diagram.setPixmap(QtGui.QPixmap("images/PhyPiDAQdiagram.png"))
        ...
        self.pB_reloadConfig.setGeometry(QtCore.QRect(590, 440, 81, 21))
        icon3 = QtGui.QIcon()
    ...
    def retranslateUi(self, PhyPiWindow):
        ...
        self.pB_reloadConfig.setToolTip(_translate("PhyPiWindow", "<html><head/><body><p>accept and reload all dependencies</p></body></html>"))
        self.pB_reloadConfig.setText(_translate("PhyPiWindow", "reload"))

...
class Ui_PhyPiWindow(object):
    def setupUi(self, PhyPiWindow):
        ...
        self.tab_Main.setGeometry(QtCore.QRect(-1, 0, 711, 611))
        ...
        self.pB_StartRun.setGeometry(QtCore.QRect(589, 525, 101, 40))
        icon = QtGui.QIcon()
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("images/open-folder.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pB_DeviceSelect0.setIcon(icon4)
        ...
        self.pB_DeviceSelect1.setIcon(icon4)
        ...
        self.pB_DeviceSelect2.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../images/flagUK.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pB_Help.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../images/flagDE.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
